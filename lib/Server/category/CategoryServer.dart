...
class CategoryRecipe {
  ...
  CategoryRecipe(this.recipeId, this.foodName, this.thumbnailImage, this.thumbnailImageByte, this.likeCount,this.category);
  ...
  factory CategoryRecipe.fromJson(Map<String, dynamic> mainContent) {
    return CategoryRecipe(
      ...
      base64Decode(mainContent['thumbnailImageByte'] ?? ''),
