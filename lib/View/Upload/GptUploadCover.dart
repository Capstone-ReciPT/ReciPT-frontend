...
import 'package:recipt/View/Upload/GptUploadAll.dart';
...
class GptUploadCover extends StatefulWidget {
  GptUploadCover({required this.togptId,required this.tofoodName,Key? key}) : super(key: key);

  final int togptId;
  final String tofoodName;

  @override
  State<GptUploadCover> createState() => _GptUploadCoverState();
}

class _GptUploadCoverState extends State<GptUploadCover> {
  bool obscure = true;
  ...
  void initState() {
    ...
    super.initState();
     foodName = widget.tofoodName;
     gptId = widget.togptId;
  }
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      CustomButton(onTap: (){
                        ...
                        else if (nextKey.currentState!.validate()) {
                          Get.to(GptUploadAll(
                            imageFile: imageFile,
                            foodName: foodName,
